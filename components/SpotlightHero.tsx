...
const SpotlightHero = () => {
    return (
        <div className="h-[33rem] sm:h-[20rem] md:h-[40rem] lg:h-[40rem] w-full flex md:items-center md:justify-center bg-slate-900 antialiased bg-grid-white/[0.02] relative overflow-hidden">
            {/* <Navbar/> */}
            {/* Sparkle effect */}
